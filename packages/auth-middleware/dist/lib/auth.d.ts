...
type AuthForSchemes<schemes extends readonly AuthScheme<any, any>[]> = AuthState<AuthSchemeIdentity<schemes[number]>>;
 ...
 */
export declare function auth<schemes extends readonly AuthScheme<any, any>[]>(options: AuthOptions<schemes>): Middleware<any, any, SetAuthContextTransform<AuthForSchemes<schemes>>>;
export {};
