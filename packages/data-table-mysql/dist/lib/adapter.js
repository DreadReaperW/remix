...
import { compileMysqlMigrationOperations as compileMysqlMigrationOperationsFromCompiler } from "./migration-compiler.js";
import { compileMysqlOperation } from "./sql-compiler.js";
import { quoteIdentifier } from "./sql-compiler-helpers.js";
/**
...
function normalizeInsertId(operation, header) {
    switch (operation.kind) {
        case 'insert':
        case 'insertMany':
        case 'upsert':
