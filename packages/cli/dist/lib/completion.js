...
const HELP_COMMANDS = ['completion', 'doctor', 'help', 'new', 'routes', 'skills', 'version'];
const ROOT_COMMANDS = ['completion', 'doctor', 'help', 'new', 'routes', 'skills', 'version'];
...
function completeSkillsDirectoryCommand(tokens, currentWord, usedGlobalFlags) {
    ...
    return completeValues(withHelpFlags([
        ...(!hasDir ? ['--dir'] : []),
        ...(!hasJson ? ['--json'] : []),
    ], usedGlobalFlags), currentWord);
}
