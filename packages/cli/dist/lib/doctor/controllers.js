...
async function getControllerFixPlans(appRoot, tree, ownership) {
...
function renderActionPlaceholder(routeNode, entryPath) {
...
function renderControllerPlaceholder(routeNode, entryPath, resolvedEntryPathByRouteName) {
    let extension = getOwnerFileExtension(entryPath);
    let lines = [];
