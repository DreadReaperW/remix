...
export function createCommandReporter(options = {}) {
    ...
    return {
        ...
        status: new ReporterStatusChannel(stderr, getState(stderr), options.statusFrameIntervalMs ?? DEFAULT_STATUS_FRAME_INTERVAL_MS),
    };
}
...
class ReporterStatusChannel extends ReporterTextChannel {
    ...
    constructor(stream, state, frameIntervalMs) {
        super(stream, state);
