...
describe('createRangeRoot', () => {
  ...
  describe('basic rendering', () => {
    it('dispose is a no-op before first render', () => {
      ...
      assert.equal(container.innerHTML, '<!--start--><!--end-->')
    })
    ...
    it('renders content between markers', () => {
      ...
      assert.equal(container.innerHTML, '<!--start--><div>Hello</div><!--end-->')
    })
    ...
    it('renders text between markers', () => {
      ...
      assert.equal(container.innerHTML, '<!--start-->Hello, world!<!--end-->')
    })
    ...
    it('renders fragments between markers', () => {
      ...
      assert.equal(container.innerHTML, '<!--start--><p>First</p><p>Second</p><!--end-->')
    })
    ...
    it('renders components between markers', () => {
      ...
      assert.equal(container.innerHTML, '<!--start--><span>Hello!</span><!--end-->')
    })
  })
  ...
  describe('updates', () => {
    it('updates content between markers', () => {
      ...
      assert.equal(container.innerHTML, '<!--start--><div>First</div><!--end-->')

      root.render(<div>Second</div>)
      root.flush()

      assert.equal(container.innerHTML, '<!--start--><div>Second</div><!--end-->')
    })
    ...
    it('handles adding children', () => {
      ...
      assert.equal(container.innerHTML, '<!--start--><div><span>Added</span></div><!--end-->')
    })
    ...
    it('handles removing children', () => {
      ...
      assert.equal(container.innerHTML, '<!--start--><div></div><!--end-->')
    })
    ...
    it('replaces all fragment children with different elements', () => {
      ...
      assert.equal(container.innerHTML, '<!--start--><div>First</div><div>Second</div><!--end-->')
      ...
      assert.equal(container.innerHTML, '<!--start--><span>A</span><span>B</span><!--end-->')
    })
    ...
    it('renders null then content', () => {
      ...
      assert.equal(container.innerHTML, '<!--start--><div>Now visible</div><!--end-->')
    })
    ...
    it('renders content then null then content', () => {
      ...
      assert.equal(container.innerHTML, '<!--start--><div>Visible</div><!--end-->')
      ...
      assert.equal(container.innerHTML, '<!--start--><span>Back again</span><!--end-->')
    })
    ...
    it('changes fragment child count', () => {
      ...
      assert.equal(container.innerHTML, '<!--start--><div>Only</div><!--end-->')
  ...
  describe('multiple range roots', () => {
    it('supports multiple ranges in same container', () => {
      ...
      assert.equal(container.querySelector('div'), existingDivA)
      assert.equal(container.querySelectorAll('div')[1], existingDivB)
    })
    ...
    it('ranges are independent', () => {
      ...
      assert.equal(container.innerHTML, '<!--a--><span>A</span><!--/a--><!--b--><!--/b-->')
  ...
  describe('boundary handling', () => {
    it('throws when start and end markers do not share a parent node', () => {
      ...
      assert.throws(() => createRangeRoot([start, end]), { message: 'Boundaries must share parent' })
    })
    ...
    it('does not affect content after end marker', () => {
      ...
      assert.equal(container.innerHTML, '<!--start--><div>New</div><!--end--><footer>After</footer>')
    })
    ...
    it('handles empty ranges with content after end marker', () => {
      ...
      assert.equal(container.querySelector('footer'), footer)
    })
