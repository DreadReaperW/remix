 ...
 */
export declare function normalizeColumnInput<input extends string>(input: input): NormalizeColumnInput<input>;
export declare function normalizeColumnInput<input extends ColumnReferenceLike>(input: input): NormalizeColumnInput<input>;
