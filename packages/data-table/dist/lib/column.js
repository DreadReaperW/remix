...
function createColumnBuilder(definition) {
...
export const column = {
    varchar(length) {
        return createColumnBuilder({ type: 'varchar', length });
    },
    text() {
        return createColumnBuilder({ type: 'text' });
    },
    integer() {
        return createColumnBuilder({ type: 'integer' });
    },
    bigint() {
        return createColumnBuilder({ type: 'bigint' });
    },
    decimal(precision, scale) {
        return createColumnBuilder({ type: 'decimal', precision, scale });
    },
    boolean() {
        return createColumnBuilder({ type: 'boolean' });
    },
    uuid() {
        return createColumnBuilder({ type: 'uuid' });
    },
    date() {
    ...
    enum(values) {
        return createColumnBuilder({ type: 'enum', enumValues: [...values] });
    },
};
