import { AlterTableBuilderRuntime } from "./alter-table-builder.js";
import { createCheckConstraint, createForeignKeyConstraint, createIndexOperation, lowerTableForCreate, toMigrationTableRef, } from "./schema-operations.js";
export function createMigrationSchema(db, emit, options) {
    return {
        async createTable(table, createOptions) {
        ...
        async addForeignKey(table, columns, refTable, refColumns, foreignKeyOptions) {
            ...
            await emit({
                kind: 'addForeignKey',
                table: tableRef,
                constraint: createForeignKeyConstraint(tableRef, columns, refTable, refColumns, foreignKeyOptions),
            });
        },
        ...
        async hasColumn(table, columnName) {
            return db.adapter.hasColumn(toMigrationTableRef(table), columnName, options?.transaction);
        },
    };
}
