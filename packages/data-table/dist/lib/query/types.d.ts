...
import type { AnyTable, TableName, TableRow, TableValidate, TimestampConfig } from '../table.ts';
...
export type QuerySourceTableName<source extends AnyQuerySource> = source extends QueryTableInput<infer tableName, any, any> ? tableName : never;
export type QuerySourceRow<source extends AnyQuerySource> = source extends QueryTableInput<any, infer row, any> ? row : never;
export type QuerySourcePrimaryKey<source extends AnyQuerySource> = source extends QueryTableInput<any, any, infer primaryKey> ? primaryKey : never;
export type QuerySourceColumnTypes<source extends AnyQuerySource> = Pretty<QueryColumnTypeMapFromRow<QuerySourceTableName<source>, QuerySourceRow<source>>>;
...
export type QueryColumnName<table extends AnyTable> = (keyof TableRow<table> & string) | `${TableName<table>}.${keyof TableRow<table> & string}`;
