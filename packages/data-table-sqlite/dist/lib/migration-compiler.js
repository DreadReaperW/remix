import { quoteIdentifier, quoteLiteral, quoteTableRef, } from "./sql-compiler-helpers.js";
export function compileSqliteMigrationOperations(operation) {
...
function compileForeignKeyReferenceClause(references) {
    return ('references ' +
