...
import { compileSqliteMigrationOperations as compileSqliteMigrationOperationsFromCompiler } from "./migration-compiler.js";
...
function normalizeInsertIdForReader(operation, rows) {
    switch (operation.kind) {
        case 'insert':
        case 'insertMany':
        case 'upsert':
...
function normalizeInsertIdForRun(operation, result) {
    switch (operation.kind) {
        case 'insert':
        case 'insertMany':
        case 'upsert':
