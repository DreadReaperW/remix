import type { AdapterCapabilityOverrides, DataMigrationResult, DataMigrationOperation, DataManipulationResult, DataManipulationOperation, DatabaseAdapter, DataMigrationRequest, DataManipulationRequest, SqlStatement, TableRef, TransactionOptions, TransactionToken } from '@remix-run/data-table/adapter';
